...
func NewService() *Service {
	models := []ModelInfo{
		...
		{ModelID: "grok-imagine-1.0-fast", GrokModel: "grok-3", ModelMode: "MODEL_MODE_FAST", Tier: TierSuper, Cost: CostHigh, DisplayName: "Grok Image Fast", Description: "Imagine waterfall image generation model for chat completions", IsImage: true},
		{ModelID: "grok-imagine-1.0", GrokModel: "grok-3", ModelMode: "MODEL_MODE_FAST", Tier: TierSuper, Cost: CostHigh, DisplayName: "Grok Image", Description: "Image generation model", IsImage: true},
		{ModelID: "grok-imagine-1.0-edit", GrokModel: "imagine-image-edit", ModelMode: "MODEL_MODE_FAST", Tier: TierSuper, Cost: CostHigh, DisplayName: "Grok Image Edit", Description: "Image edit model", IsImageEdit: true},
